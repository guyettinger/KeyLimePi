 ...
 *
 * `replace_lines` is Key Lime Pi's own, but it modifies a file through the same `path`
 ...
 *
 * `refactor` is the first tool Key Lime Pi has that changes more than one file in a single
